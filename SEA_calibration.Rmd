...
yieldObs_timeVariant <- readRDS("yieldObs_timeVariant.rds") #empirical data 
...
## getting model catches from sim 3 and the observed catches from cami's code and formatting them to match the time series
...
# running getError multiple times to reproduce catches that represent empirical catches
