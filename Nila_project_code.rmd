...
setwd("~/Documents/SEAusMizer/SouthEastAustraliaMizer/")
...
Still not reaching coexistence, editing squalus rmax
...
sim_uncalibrated <- project(params5, effort = Fishing_ssp1_scaled)
...
sim_guessed <- project(params_guessed, effort = Fishing_ssp1_scaled)
